...
**مشاعر** هي لعبة كروت تفاعلية للأزواج، الفكرة إنكم تختاروا فئة أسئلة (أو تلعبوا كل الفئات مع بعض) وتقلبوا الكروت واحد ورا التاني، كل كرت فيه سؤال يفتح باب كلام وقرب أكتر بينكم. اللعبة فيها أكتر من **500 سؤال** موزعين على 5 فئات مختلفة، بالإضافة لوضع تصفح يسمحلكم تشوفوا كل الأسئلة قبل ما تلعبوا.
...
> *(تقدر تضيف هنا صور Screenshot من شاشة البداية، شاشة الكرت، ووضع التصفح)*

| الشاشة الرئيسية | شاشة اللعب | تصفح الأسئلة |
|:---:|:---:|:---:|
| `screenshot-home.png` | `screenshot-game.png` | `screenshot-browse.png` |
